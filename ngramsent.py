##NOTE: Dataset used was a private dataset, not available for distribution##
##Author: Pranay: pranaydeeps@gmail.com##
...
start=time.time()
training_data=pd.read_csv("train.csv",header=0) #Reading the training CSV file
test_data=pd.read_csv("test.csv",header=0) #Reading the test CSV file
